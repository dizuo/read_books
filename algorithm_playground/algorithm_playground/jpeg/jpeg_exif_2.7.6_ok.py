...
class IfdData: 
    ...
    def __init__(self, e, offset, exif_file, mode, data = None): 
        ...
        for i in range(num_entries): 
            ...
            #ERROR Here. actual_data is a list.
            #Bytes of JPEG data                       <__main__.ExifType instance at 0x1004b7560>      1 [4183]
...
def ifd_maker_note(e, offset, exif_file, mode, data): 
    ...
    if exif_file.make == "Canon": 
        ...
        debug("Unknown maker: %s. Can't currently handle this." % exif_file.make) 
...
class JpegFile: 
    ...
    def __init__(self, input, filename=None, mode="rw"): 
        ...
        while 1: 
            ...
            print(delim, head[1], head2, size, len(possible_segment_classes))#dizuo
            print(possible_segment_classes)#dizuo
