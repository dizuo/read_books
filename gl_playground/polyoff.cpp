...
// peteryfren NextStep : Use GLSL to implement PolygonOffset.
// 2014-12-30
...
GLint spiny = 0;
GLfloat tdist = 0.0;
GLfloat polyfactor = 0.0;	// 1.0
const GLuint u_step = (2 << 24);
GLfloat polyunits = 1.0/u_step;	// 1.0
